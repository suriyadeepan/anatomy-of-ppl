...
def main(args):
    ...
    def guide(data):
        ...
        guide_scale = pyro.param("guide_scale_log", torch.tensor(0.), torch.distributions.constraints.positive).exp()
...
if __name__ == "__main__":
    # assert pyro.__version__.startswith('0.3.1'), pyro.__version__
